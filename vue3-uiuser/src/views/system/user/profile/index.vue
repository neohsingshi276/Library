            ...
            <el-card class="box-card">
               ...
               <div class="profile-card-body">
                  ...
                  <ul class="list-group list-group-striped info-list">
                     ...
                     <li class="list-group-item info-item">
                        <div class="item-left">
                          <svg-icon icon-class="star" class="item-icon" />
                          <span class="item-label">Credit Score</span>
                        </div>
                        <div class="item-value">{{ state.user.creditScore || 100 }} points</div>
                     </li>
                     <li class="list-group-item info-item">
                        <div class="item-left">
                          <svg-icon icon-class="money" class="item-icon" />
                          <span class="item-label">Total Donation</span>
                        </div>
                        <div class="item-value">¥{{ (state.user.totalDonation || 0).toFixed(2) }}</div>
                     </li>
                     <li class="list-group-item info-item">
                        <div class="item-left">
                          <svg-icon icon-class="date" class="item-icon" />
                          <span class="item-label">Registration Time</span>
                        </div>

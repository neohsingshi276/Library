<template>
  <div class="user-info-head" @click="editCropper()">
    ...
    <el-dialog :title="title" v-model="open" width="1500px" append-to-body @opened="modalOpened" @close="closeDialog">
      <el-row>
...
function beforeUpload(file) {
  if (file.type.indexOf("image/") == -1) {
    proxy.$modal.msgError("Invalid file format, please upload image files such as JPG, PNG.");
  } else {

<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" v-show="showSearch" :inline="true" label-width="120px">
      ...
      <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="Actions" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
              ...
              <el-tooltip content="Assign User" placement="top" v-if="scope.row.roleId !== 1">
...
const dataScopeOptions = ref([
  { value: "1", label: "All Data Permission" },
  { value: "2", label: "Custom Data Permission" },
  { value: "3", label: "Department Data Permission" },
  { value: "4", label: "Department and Below Data Permission" },
  { value: "5", label: "Personal Data Permission Only" }
]);
...
function handleStatusChange(row) {
  ...
  proxy.$modal.confirm('Are you sure you want to "' + text + '" the role "' + row.roleName + '"?').then(function () {
...
/** Role permission scope selection change trigger */
...
function handleDataScope(row) {
  ...
  getRole(row.roleId).then(response => {
    ...
    title.value = "Assign Data Permission";
  });
}

<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
         ...
         />
         <el-table-column label="Announcement Type" align="center" prop="noticeType" width="100">
      ...
      <el-dialog :title="title" v-model="open" width="900px" append-to-body>
         <el-form ref="noticeRef" :model="form" :rules="rules" label-width="180px">
            <el-row>
               <el-col :span="12">
                  <el-form-item label="Announcement Title" prop="noticeTitle">
               ...
               <el-col :span="12">
                  <el-form-item label="Announcement Type" prop="noticeType">
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('Are you sure to delete announcement No. "' + noticeIds + '"?').then(function() {
